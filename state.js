...
export class StandingLeft extends State{
    ...
    //EL METODO HARA TODDO LO QUE HAY Q HACER CUANDO EL PLAYER INGRESE A ESTE ESTADO COMO CAMBIAR VELOCIDAD O CAMBIAR THE SPRITE SHEET. SE EJECUTARA UNA UNICA VEZ
    enter(){
        this.player.frameY = 1
        this.player.speed = 0
        this.player.maxFrame = 2
    }
    //ESTE METODO ESCUCHARA UN CONJUNTO PREDEFINIDO DE ENTRADAS Y CAMBIARA AL ESTADO CORRESPONDIENTE A LA TECLA PRESIONADA. SE PODRA EJECUTAR VARIAS VECES POR CADA FRAME
    handleInput(input){
...
export class RunningLeft extends State{
    ...
    handleInput(input){
        ...
        else if(!this.player.onGround() && !this.player.onblock) this.player.setState(states.FALLING_LEFT)
    }
}
export class RunningRight extends State{
    ...
    handleInput(input){
        ...
        else if(!this.player.onGround() && !this.player.onblock) this.player.setState(states.FALLING_RIGHT)
    }
}
export class JumpingLeft extends State{
    ...
    enter(){
        ...
        if(this.player.onGround() || this.player.onblock){
            this.player.vy = -20
            // console.log("hola-->",this.player.y,this.player.onblock,this.player.vy)
        } 
    ...
    handleInput(input){
        ...
        //     this.player.speed = -this.player.maxSpeed * 0.5
        // } 
        else if(this.player.onGround() || this.player.onblock) this.player.setState(states.STANDING_LEFT)
...
export class JumpingRight extends State{
    ...
    handleInput(input){
        ...
        //     this.player.speed = this.player.maxSpeed * 0.5
        // } 
        else if(this.player.onGround() || this.player.onblock) this.player.setState(states.STANDING_RIGHT)
...
export class FallingRight extends State{
    ...
    handleInput(input){
        ...
        // if(!this.onblock) this.player.setState(states.STANDING_RIGHT)
    }
}